        ...
        <>
            ...
            <section className="container d-flex gap-4">
                                ...
                                <div className="module-banner image align-left align-top full-text">
                                    <div className="module-body"><div className="banner-wrapper">
                                        ...
                                        <div className="banner-thumbnail">
                                            <img decoding="async" src={require('../../assets/images/widget-1.jpg')} alt="banner" className="w-100 rounded-3" />
                                        </div>
                                ...
                                <div className="module-banner image align-left align-top full-text">
                                    <div className="module-body">
                                        <div className="banner-wrapper">
                                            ...
                                            <div className="banner-thumbnail">
                                                <img decoding="async" src={require('../../assets/images/widget-2.jpg')} alt="banner" className="w-100 rounded-3" />
                                            </div>
                                            <a href="/" className="overlay-link">
                                            </a>
                                        </div>
                ...
                <div className="col-9">
                    ...
                    <Slider {...settings}>
                        <div className="product-wrapper border">
